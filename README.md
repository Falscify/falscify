...
![Project Logo](graphics/inline.png)

**Falscify** is a P2P-driven, innovative database containing negative results of scientific research in many different fields of science.
